...
候補は通常撮影向けの暫定値（基準の1.5秒前・0.25秒前・基準位置・0.8秒後）です。ゴルフの場面を自動認識する機能ではなく、テンポやスロー撮影ではずれます。範囲外は補完せず手動で選びます。候補作成は追加APIを使わず、画像は本人の一括確認後に記録へ進めます。登録時間の短縮や選択精度は実機評価待ちです。
